...
---
So, week #2 of bootcamp has already flown by and we’re also day 3,504,229(?) into quarantine. It’s taken quite a bit of time to adapt to this new status quo of voluntary incarceration. On some days, I feel a bit like Andy out of The _Shawshank Redemption_, finding myself day-dreaming about what it would be like breaking out of my metaphorical prison and spending the day in the sun climbing or having a beer with mates. Then quickly realise, I wouldn’t have enough spoons to make it past the living room.
...
The course is fast paced and I’ve been left thinking “thank God, I did the precourse preparation” a fair few times. We’ve had some great support from the faculty available at [DevelopMe_](https://developme.tech/) though and our tutors including Ruth, Jack and Kye, who have all made the transition to remote working in particularly short timescales, seem effortless.
...
After qualifying the brief, we scamped the design in groups, built a wireframe using Figma and later tested our code for bugs, validation and accessability using a number of tools like [WC3 Validator](https://validator.w3.org/), [Wave](https://wave.webaim.org/) and [Lighthouse](https://developers.google.com/web/tools/lighthouse).
