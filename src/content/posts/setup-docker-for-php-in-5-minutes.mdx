...
What this isn't going to cover is how you can go about creating this from scratch yourself, but I will include some pointers on where you can look if you want to omit some of the optional tools above.
...
### Install Laravel
This is the part of the process where you can choose to omit installing some of the optional tools listed above. If you wanted to setup a slimmmer environment without Redis, Node or the MySQL client PHPMyAdmin then all you would now need to do is delete the following hostnames and their details from the `docker-compose.yml` file:
